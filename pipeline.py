...
def construir_params(
    ...
    # tax_rate y discount_rate llegan como fracción (0-1).
    # La UI convierte vía dropdown Fraction/Percentage antes
    # de pasar los valores acá, así que no hay heurística.
    return {
